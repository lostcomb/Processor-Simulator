...
/* package aca-processor-simulator-0.1.0.0 */
#define VERSION_aca_processor_simulator "0.1.0.0"
#define MIN_VERSION_aca_processor_simulator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "aca-processor-simulator-0.1.0.0"

#define CURRENT_PACKAGE_KEY "aca-processor-simulator-0.1.0.0"
